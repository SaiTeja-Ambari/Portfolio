  ...
  return (
    <header className="header" id="home">
      ...
      <div className="info">
        ...
        <p>
        Welcome to my portfolio! I'm Sai Teja Ambari, a Master's student at Syracuse University with a passion for technology and innovation. Here, you'll find a showcase of my projects and experiences, from developing full-stack applications to enhancing software with cutting-edge technologies. My work as a software engineer and teaching assistant has equipped me with a diverse skill set, including expertise in Java, Python, ReactJS, and more. Each project reflects my commitment to solving complex problems and contributing to the tech community. Dive in to explore my journey and the solutions I've crafted along the way.

I'm set to graduate in May 2024 and am actively seeking full-time Software Development Engineer (SDE) roles. I'm excited about the opportunity to bring my strong technical background and problem-solving skills to a dynamic team, where I can contribute to meaningful projects and continue to grow as a developer. Let's connect and explore how I can contribute to your team with my passion for technology and innovation.
        </p>
        </div>
